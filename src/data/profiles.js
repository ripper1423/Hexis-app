export const PROFILES = {
  ...
  ARTEMISA: {
    ...
    tagline:"Afinas cada detalle. La preparación no perdona la improvisación.",
    ...
    habitIcons:["🌙","⚖️","📊","🏋️"],
    manifesto:"Cada semana ajustas algo más. La definición final se construye mucho antes de la descarga.",
  ...
  HÉRCULES: {
    ...
    days:6, goal:"Culturismo natural por fases: superávit controlado en carga, déficit sostenido en descarga. Fase 1 de 12 semanas, cero atajos farmacológicos.", phase:"Fase 1 · Fundamentos", week:12,
    ...
    habitIcons:["📝","⚖️","😴","📈"],
    manifesto:"No construyes esto en un día. Cada bloque de carga sostiene al siguiente, cada descarga protege lo que ganaste.",
