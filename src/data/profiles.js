export const PROFILES = {
  ...
  ATLAS: {
    color:"#B8926A", sub:"El Estabilizador",
    tagline:"Ordenas antes de exigir. Tu cuerpo responde al sistema, no al castigo.",
    cal:2252, prot:173, carbs:237, fat:68,
    days:3, goal:"Déficit moderado -500 kcal · Sin exceso de entreno", phase:"Fase 1 · Fundamentals", week:12,
    feeling:["balanced","confident"], obstacle:["eating","noconstancy"],
    habits:["Registra qué comes, sin juzgarlo","Come a horas fijas, no a deshoras","8000 pasos diarios (NEAT)","Proteína en cada comida"],
    habitIcons:["📝","⏰","👣","🥩"],
    ...
    weekPlan:[
      ...
      {day:"M",focus:"Caminar 30 min",type:"cardio",done:true},
      {day:"X",focus:"Descanso total",type:"rest",done:false},
      {day:"J",focus:"Full Body B · Base",type:"train",done:false,split:"fullbody_b"},
      {day:"V",focus:"Caminar 30 min",type:"cardio",done:false},
      {day:"S",focus:"Movilidad libre",type:"mobility",done:false},
      {day:"D",focus:"Descanso total",type:"rest",done:false},
    ],
  ...
  ATALANTA: {
    color:"#C9A89A", sub:"La Constante",
    tagline:"Avanzas sin prisa. Cada comida ordenada es un paso que no retrocede.",
    cal:2032, prot:173, carbs:198, fat:61,
    days:3, goal:"Déficit moderado -450 kcal · Sin exceso de entreno", phase:"Fase 1 · Fundamentals", week:12,
    feeling:["light","balanced"], obstacle:["eating","confused"],
    habits:["Registra qué comes, sin juzgarlo","Come a horas fijas, no a deshoras","8000 pasos diarios (NEAT)","Hidratación 2L"],
    habitIcons:["📝","⏰","👣","💧"],
  ...
  'HÉRCULES': {
    color:"#B08D3E", sub:"El que se Forja",
    tagline:"Cada fase te acerca a la tarima. No hay atajos, solo estructura.",
    cal:2861, prot:165, carbs:357, fat:86,
    days:5, goal:"Fase 1 · Volumen e hipertrofia · Superávit +200 kcal", phase:"Fase 1 · Fundamentals", week:12,
    feeling:["strong","focused"], obstacle:["noconstancy","confused"],
    habits:["Duerme mínimo 8h","Proteína en cada comida","Registra tus RMs cada 4 semanas","Sube el peso si completas las reps","Creatina 5g diaria"],
    habitIcons:["🌙","🥩","📊","🏋️","💊"],
    manifesto:"No te preparas para un día. Te forjas fase a fase hasta que no quede nada que ajustar.",
    supps:[["Creatina","5g","Post-entreno con agua"],["Proteína Whey","30g","Post-entreno"],["Vitamina D3","2000 UI","Con desayuno"],["Omega 3","2g","Con la comida principal"]],
    weekPlan:[
      {day:"L",focus:"Empuje · Pecho y Hombros",type:"train",done:true,split:"empuje"},
      {day:"M",focus:"Tirón · Espalda y Bíceps",type:"train",done:false,split:"tiron"},
      {day:"X",focus:"Descanso activo",type:"rest",done:false},
      {day:"J",focus:"Pierna · Fuerza e hipertrofia",type:"train",done:false,split:"pierna"},
      {day:"V",focus:"Hombros y Brazos",type:"train",done:false,split:"hombros_brazos"},
      {day:"S",focus:"Full Body o Cardio",type:"train",done:false,split:"fullbody"},
      {day:"D",focus:"Descanso total",type:"rest",done:false},
    ],
  },
  ARTEMISA: {
    color:"#8F6A8C", sub:"La Cazadora",
    tagline:"Afinas cada detalle. La tarima no perdona la improvisación.",
    cal:2582, prot:165, carbs:307, fat:77,
    days:5, goal:"Fase 1 · Volumen e hipertrofia · Superávit +150 kcal", phase:"Fase 1 · Fundamentals", week:12,
    feeling:["strong","confident"], obstacle:["confused","eating"],
    habits:["Duerme mínimo 8h","Pesa tus comidas","Registra tus RMs cada 4 semanas","Sube el peso si completas las reps"],
    habitIcons:["🌙","⚖️","📊","🏋️"],
    ...
    weekPlan:[
      ...
      {day:"M",focus:"Tirón · Espalda y Bíceps",type:"train",done:false,split:"tiron"},
      {day:"X",focus:"Descanso activo",type:"rest",done:false},
      {day:"J",focus:"Pierna · Glúteo y Cuádriceps",type:"train",done:false,split:"pierna"},
      {day:"V",focus:"Hombros y Brazos",type:"train",done:false,split:"hombros_brazos"},
      {day:"S",focus:"Full Body o Cardio",type:"train",done:false,split:"fullbody"},
      {day:"D",focus:"Descanso total",type:"rest",done:false},
    ],
